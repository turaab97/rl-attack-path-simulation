...
echo "============================================================"
echo ""
echo "  NOTE: The RECOMMENDED way to reproduce results is via"
echo "  Google Colab (zero local setup, ~30 min on T4 GPU)."
echo "  See README.md Option A or open:"
echo "    notebooks/00_colab_training.ipynb"
echo ""
echo "  This script provides a local alternative. If anything"
echo "  fails, please use the Colab notebook instead."
echo ""
